...
const Department = ({readPath}) => {
  return (
        ...
        <path d="M8.99999 2.625H12C13.8152 2.625 14 3.59619 14 5.25C14 6.90381 13.8152 7.875 12 7.875H8.99999C7.1848 7.875 7 6.90381 7 5.25C7 3.59619 7.1848 2.625 8.99999 2.625Z" stroke={readPath === 'Admin/Department' ||  readPath === 'Admin/DepartmentView/SubDepartmentView' || readPath === 'Admin/DepartmentView' || readPath === 'Admin/OrganizationPages/Department' || readPath === 'Admin/OrganizationPages/DepartmentView/SubDepartmentView' ||  readPath === 'Admin/OrganizationPages/DepartmentView'  ? 'white' : '#5D6150'}  strokeWidth="1.3125"/>
        </svg>
