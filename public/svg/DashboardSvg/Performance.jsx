...
const Performance = ({readPath}) => {
  return (
    <svg width="21" height="21" viewBox="0 0 21 21" fill="none" xmlns="http://www.w3.org/2000/svg" stroke={ readPath === 'Admin/PerformancePages/Overview' || readPath === 'EmployeePortal/PerformancePages/MyPerformance'  || readPath === "Admin/PerformancePages/Goals" || readPath === 'Admin/PerformancePages/FeedBack' || readPath === 'Admin/PerformancePages/Reviews' || readPath === 'EmployeePortal/Performance/Goals' || readPath === "EmployeePortal/Performance/Reviews" || readPath === "EmployeePortal/Performance/Feedback" || readPath === "EmployeePortal/Performance/MyPerformance" || readPath === 'SuperAdmin/UserStatics' ? 'white' : '#5D6150'} strokeWidth="1.5">
