...
const Employee = ({readPath}) => {
  return (
    <svg width="21" height="21" viewBox="0 0 21 21" fill="none" xmlns="http://www.w3.org/2000/svg" stroke={readPath === 'Admin/Employees' || readPath === 'Admin/OrganizationPages/Employees' || readPath === 'Admin/EmployeeRegistration/AddNewemployee'  || readPath === "Admin/EmployeeView" || readPath === 'Admin/EmployeeRegistration/AddNewemployeesecond' || readPath === 'Admin/EmployeeRegistration/Compensation' || readPath === 'Admin/EmployeeRegistration/System' || readPath === 'Admin/OrganizationPages/EmployeeRegistration/AddNewemployee'  || readPath === "Admin/EmployeeView" || readPath === 'Admin/OrganizationPages/EmployeeRegistration/AddNewemployeesecond' || readPath === 'Admin/OrganizationPages/EmployeeRegistration/Compensation' || readPath === 'Admin/OrganizationPages/EmployeeRegistration/System' ? 'white' : '#5D6150'} strokeWidth="1.5">
