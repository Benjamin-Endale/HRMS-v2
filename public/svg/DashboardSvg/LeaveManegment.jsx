...
const LeaveManegment = ({readPath}) => {
  return (
    <svg width="21" height="21" viewBox="0 0 21 21" fill="none" xmlns="http://www.w3.org/2000/svg" stroke={ readPath === 'EmployeePortal/LeaveRequest/Approved' || readPath === 'EmployeePortal/LeaveRequest/Pending' || readPath === 'EmployeePortal/LeaveRequest/Rejected' ? 'white' : '#5D6150'} strokeWidth="1.3125">
