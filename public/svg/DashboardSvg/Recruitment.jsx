...
const Recruitment = ({readPath}) => {
  return (
    <svg width="21" height="21" viewBox="0 0 21 21" fill="none" xmlns="http://www.w3.org/2000/svg" stroke={readPath === 'Recruitment' || readPath === 'RecruitmentPages/Jobposting' || readPath === 'RecruitmentPages/Candidates' || readPath === 'RecruitmentPages/Interviews'? 'white' : '#5D6150'} strokeWidth="1.5">
