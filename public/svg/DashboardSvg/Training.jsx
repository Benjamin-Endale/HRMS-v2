...
const Training = ({readPath}) => {
  return (
    <svg width="21" height="21" viewBox="0 0 21 21" fill="none" xmlns="http://www.w3.org/2000/svg" stroke={readPath === 'Training' || readPath === 'TrainingPages/OverviewTraining'  || readPath === 'TrainingPages/Feedback' || readPath === 'TrainingPages/Enrolment' || readPath === 'EmployeePortal/Training' || readPath === 'TrainingPages/Program' ? 'white' : '#5D6150'} strokeWidth="1.5">
