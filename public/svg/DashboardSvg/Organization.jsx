...
const Organization = ({readPath}) => {
  return (
     <svg width="21" height="21" viewBox="0 0 21 21" fill="none" xmlns="http://www.w3.org/2000/svg" stroke={readPath === 'Admin/Organization' || readPath === 'Admin/OrganizationView' || readPath === 'SuperAdmin/CreateOrganization/CreateTenant' || readPath === "SuperAdmin/CreateOrganization/RegisterAdmin" || readPath === "SuperAdmin/CreateOrganization/UserAccess" || readPath === "SuperAdmin/CreateOrganization/Compensation" ? 'white' : '#5D6150'} strokeWidth="1.3125">
