...
const page = () => {
  return (
      <div className='font-semibold'>
        <EmployeePortalSubNav readPath= '/EmployeePortal/Training/Enrolment'/>
        <div className='flex gap-[2.125rem] mt-[3.6875rem] '>
            <div className='w-[71.9375rem] h-[3.4375rem]  bg-[rgba(21,24,18,1)] flex items-center gap-[1.1875rem] rounded-[0.625rem] px-[1.4375rem] '>
              <img src="/svg/SvgImage/Search.svg" alt="" />
                <input type="search" placeholder="Search enrolled program" className='placeholder-input text-white  w-full h-full outline-0' name="" id="" />
            </div>
