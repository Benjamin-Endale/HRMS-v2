...
const page = () => {
  ...
  const employee = [
    {EmployeeId: 'EMP001' , EmployeeName:'Benjamin Endale', Email: 'rabbitedhole@gmail.com', Role: '--' , Position:'Senior Software Dev'},
    {EmployeeId: 'EMP002' , EmployeeName:'Benjamin Endale', Email: 'rabbitedhole@gmail.com', Role: '--' , Position:'Senior Software Dev'}
                  ...
                  <tr key={emp.EmployeeId}>
                    ...
                    <td className='flex items-center gap-[2.5625rem] pt-[2.25rem]'>
                      ...
                      <ModalContainerAuth  open={isOpen}>
                          <AddAuth onClose={() => setisOpen(false)} />
                      </ModalContainerAuth>
                    </td>
                  </tr>
                ))}
