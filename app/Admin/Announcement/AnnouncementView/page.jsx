...
const page = ({token,tenantId , Announcement}) => {

      if(Announcement.message === "No announcements found for this user."){
        ...
        <div className='flex gap-[1.25rem]  font-semibold'>
          <div className='carDash2'>
              ...
              <div className='flex flex-col'>
                  <span className='text-5xl text-formColor'>{Announcement.totalAnnouncements}</span>
          ...
          <div className='carDash2'>
              ...
              <div className='flex flex-col'>
                  <span className='text-5xl text-formColor'>{Announcement.currentAnnouncements}</span>
          ...
          <div className='carDash2'>
              ...
              <div className='flex flex-col'>
                  <span className='text-5xl text-formColor'>{Announcement.reachPercentage}%</span>
                ...
                <div className='between-center'>
                    ...
                    <div>
                        ...
                        <ModalContainerAnnounce  open={isOpen}>
                            <AddAnnounce token={token} tenantId={tenantId} onClose={() => setisOpen(false)} />
      ...
      <div>
        <table>
          ...
          <tbody className='space-y-[2.125rem]'>
            {Announcement.announcementemployee.length > 0 ? (Announcement.announcementemployee.map((anc) => (
                <tr key={anc.id}>
                <td className='pt-[2.0625rem]'><h4 className='textLimeGray1'>{anc.title}</h4></td>
                <td className='pt-[2.0625rem]'><h4 className='textLimeGray1'>{anc.announcementcontent}</h4></td>
                ...
                <td className='pt-[2.0625rem]'><h4 className='textFormColor1'>{anc.categories}</h4></td>
            ...
            ) )) : (<tr><td>No Announcement Found</td></tr>)}
          </tbody>
        </table>
      </div>
    </div>
