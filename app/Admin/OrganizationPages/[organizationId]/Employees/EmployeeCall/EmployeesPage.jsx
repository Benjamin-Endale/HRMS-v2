              ...
              filteredUsers.map((emp) => (
                <tr key={emp.employeeCode}>
                  ...
                  <td className='flex items-center gap-[2.5625rem] pt-[2.25rem]'>
                    <button className='cursor-pointer' onClick={() => router.push(`/Admin/OrganizationPages/${emp.organizationId}/EmployeeView/${emp.employeeID}`)}>
                      <img src="/image/Icon/Action/eye.png" alt="" />
                    </button>
                    <button className='cursor-pointer' onClick={() => router.push(`/Admin/OrganizationPages/${emp.organizationId}/EmployeeEdit/${emp.employeeID}`)}>
