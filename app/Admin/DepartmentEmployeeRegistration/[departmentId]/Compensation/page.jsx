...
taxIdenitificationNumber: z
  ...
  const {departmentId} = React.use(params)
    ...
    const onSubmit = (data) => {
      ...
      router.push(`/Admin/DepartmentEmployeeRegistration/${departmentId}/System`)
    }
      ...
      <div className='font-semibold flex flex-col gap-[4rem]'>
        ...
        <div className='flex flex-col gap-[2.5rem]'>
          <div className='flex items-center gap-[0.9375rem]'>
            <img
              onClick={() => router.push(`/Admin/DepartmentEmployeeRegistration/${departmentId}/AddNewemployeesecond`)}
