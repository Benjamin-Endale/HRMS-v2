...
const {addEmployeeSecond, setAddEmployeeSecond} = useAdminForm();
  ...
  const onSubmit = (data) => {
    ...
    router.push(`/Admin/DepartmentEmployeeRegistration/${departmentId}/Compensation`);         
  };
    ...
    <div className='font-semibold flex flex-col gap-[4rem]'>
      ...
      <div className='flex flex-col gap-[2.5rem]'>
        <div className='flex items-center gap-[0.9375rem]'>
          <img 
            onClick={() => router.push(`/DepartmentEmployeeRegistration/${departmentId}/AddNewemployee`)} 
