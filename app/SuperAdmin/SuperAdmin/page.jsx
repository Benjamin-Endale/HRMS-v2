...
const page = () => {
  ...
  const AdminList = [
    {Administrator: 'Onyx Technology' , AdminEmail:'john@techcorp.com', Role: 'Super Administrator',  Status: 'Active'   , LastLogin: '1/15/2024', Created: '1/15/2024'},
    {Administrator: 'Bright Technology' , AdminEmail:'john@techcorp.com', Role: 'Super Administrator',  Status: 'InActive'   , LastLogin: '1/15/2024', Created: '1/15/2024'},
    {Administrator: 'Sun Technology' , AdminEmail:'john@techcorp.com', Role: 'Super Administrator',  Status: 'Active'   , LastLogin: '1/15/2024', Created: '1/15/2024'},
        ...
        <div className='space-y-[3.0625rem]'>
          ...
          <div className='pb-[2.1875rem]'>
            <table className='w-full  '>
              ...
              <tbody >
                {AdminList.map((admin) => (
                  <tr key={admin.Administrator}>
                    <td className='pt-[2.1875rem]'>
                      <div>
                        <h1 className='text-limeLight'>{admin.Administrator}</h1>
                        <h4 className='textLimegray'>{admin.AdminEmail}</h4>
                      </div>
                    </td>
                  <td className='pt-[2.1875rem]'>
                      <h4 className='text-limegray'>{admin.Role}</h4>
                    </td>
                    <td className='pt-[2.1875rem]'>
                      <span className={`bg-[rgba(190,229,50,0.05)] px-[20px] py-[8px] rounded-full ${handleState(admin.Status)}`}>{admin.Status}</span>
                    </td>
                    <td className='pt-[2.1875rem] '>
                      <div>
                          <h4 className='text-limegray'>{admin.LastLogin}</h4>
                      </div>
                    </td>
                    <td className='pt-[2.1875rem]'>
                      <div>
                        <h4 className='text-limegray'>{admin.Created}</h4>
                      </div>
                    </td>
