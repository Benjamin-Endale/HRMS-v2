...
const Page = () => {
  ...
  const { register, control, handleSubmit, formState: { errors } } = useForm({
    ...
    defaultValues:{
      OrgName:"", Domain:"", Industry:"", CompanySize:"", Description:"",
  ...
  const onSubmit = (data) => {
    ...
    console.log("Left Modules:", toggleOn);
    console.log("Right Modules:", toggleOn2);
    // router.push('/System');
  }
              ...
              <div className='flex gap-[2.1875rem]'>
                <div className='w-[20.1875rem] flex flex-col gap-[2.875rem]'>
                  <div className='flex flex-col gap-[1rem]'>
                    ...
                    <input type="text" placeholder='Enter Organization Name' className='inputMod' {...register("OrgName")} />
                    {errors.OrgName && <span className='text-Error text-[1rem]'>{errors.OrgName.message}</span>}
                  </div>
                  <div>
                    <Controller
                      control={control}
          ...
          <div className='flex gap-[2.1875rem]'>
            <div className='w-[20.1875rem] flex flex-col gap-[2.875rem]'>
              <div className='flex flex-col gap-[1rem]'>
                ...
                <input type="text" placeholder='Enter First Name' className='inputMod' {...register("FirstName")} />
              ...
              <div className='flex flex-col gap-[1rem]'>
                ...
                <input type="email" placeholder='example@company.name' className='inputMod' {...register("Email")} />
            ...
            <div className='w-[20.1875rem] flex flex-col gap-[2.875rem]'>
              <div className='flex flex-col gap-[1rem]'>
                ...
                <input type="text" placeholder='Enter Last Name' className='inputMod' {...register("LastName")} />
              ...
              <div className='flex flex-col gap-[1rem]'>
                ...
                <input type="text" placeholder='+1(555) 123-4567' className='inputMod' {...register("Phone")} />
