...
const Header = ({ readPath , session }) => {
  ...
  const keyMap = {
    ...
    "RecruitmentPages/Shortlist": "Recruitment_and_ATS",
    'Performance': 'Performance_Management',
    'PerformancePages/Overview': 'Performance_Management',
    'PerformancePages/Goals': 'Performance_Management',
    'PerformancePages/Reviews': 'Performance_Management',
    'PerformancePages/FeedBack': 'Performance_Management',
