...
//   instructions: z.string().max(500, 'Max 500 characters').min(1,"Instruction is required"),
// })
...
const CreateOrgSchema=z.object({
  ...
  CompanyName:z.string().min(3,"Company size is required"),
      ...
      <div className='w-[42.5625rem]'>
        ...
        <div className='flex flex-col gap-[4.5625rem]'>
          <div className='flex flex-col gap-[2.4375rem]'>
            ...
            {/* FormSection */}
            <div>             
              <form id='orgform' onSubmit={handleSubmit(onSubmit)} action="" className='space-y-[2.875rem]'>
            ...
            <div className='space-y-[2.875rem]'>
              ...
              <div className='space-y-[2.875rem]'>
                ...
                <div className='w-full h-[3.4375rem] flex gap-[2.5625rem] mb-[4.125rem]'>
                    <button type="button" form='orgform'  className='w-[19.875rem] border border-formColor text-formColor rounded-[10px] cursor-pointer'>Cancel</button>
