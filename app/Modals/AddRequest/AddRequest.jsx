    ...
    <div className='px-[3rem] py-[2.875rem]  space-y-[3.125rem] font-semibold w-full  ' >
        ...
        <form action="" className='flex flex-col gap-[2.375rem]'>
          <div className=' w-full flex gap-[1.125rem]'>
            {/* Employee  */}
              <div className='flex flex-col w-full gap-[1rem]'>
                  <label htmlFor="" className='textFormColor1'>Employee </label>
                  <input type="text" placeholder='Select employee' className='inputMod pr-[1.5625rem] ' />
              </div>
              {/* Location */}
              <div className='flex flex-col w-full gap-[1rem] '>
                  <label htmlFor="" className='textFormColor1'>Feedback Deadline</label>
                  <input type="date" placeholder='Pick a date'  className='inputMod  pr-[1.5625rem]  ' />
              </div>
          </div>
          ...
          <div className='w-full h-[3.4375rem] mt-[0.5rem]'>
              <button type="submit" onClick={()=>navigate('/')} className='w-full h-full bg-lemongreen rounded-[10px] cursor-pointer'>Next</button>
          </div>
        </form>
    </div>
  )
